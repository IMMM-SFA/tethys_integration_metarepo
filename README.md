...
Tethys ingests global power plant data for reason [TODO... cooling water withdrawal?]. The format is a NetCDF with plant capacities in MetaWatts (MW) aggregated (summed) onto an 1/8 degree grid by generic technology/fuel type.
