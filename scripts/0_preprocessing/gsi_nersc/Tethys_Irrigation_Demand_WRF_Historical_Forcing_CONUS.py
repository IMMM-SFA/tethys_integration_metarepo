...
wrf_path = '/global/project/projectdirs/m2702/gsharing/tgw-wrf-conus/historical_1980_2019/hourly/tgw_wrf_historical_hourly_'

outputDir='/global/project/projectdirs/m2702/dardiry/Tethys_Demand/Outputs/TGW/Historical/daily'
...
for year in range(start_year,end_year+1):
    ...
    print('Processing WRF Forcing for %d'%year)
